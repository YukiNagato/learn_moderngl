...
class Scene:
    ...
    def render(self):
        ...
        self.pipline.scale(np.sin(self.scale * 0.1))
        self.pipline.world_pos((np.sin(self.scale), 0, 0))
        self.pipline.rotate((np.sin(self.scale)*90, np.sin(self.scale)*90, np.sin(self.scale)*90))
